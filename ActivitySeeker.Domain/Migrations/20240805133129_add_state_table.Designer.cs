...
namespace ActivitySeeker.Domain.Migrations
{
    ...
    [Migration("20240805133129_add_state_table")]
    partial class add_state_table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActivitySeeker.Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 13, 16, 31, 29, 569, DateTimeKind.Local).AddTicks(2329)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 8, 16, 31, 29, 569, DateTimeKind.Local).AddTicks(2351)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 6, 16, 31, 29, 569, DateTimeKind.Local).AddTicks(2354)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 9, 5, 16, 31, 29, 569, DateTimeKind.Local).AddTicks(2356)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 5, 16, 31, 29, 569, DateTimeKind.Local).AddTicks(2359)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 7, 16, 31, 29, 569, DateTimeKind.Local).AddTicks(2362)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 10, 16, 31, 29, 569, DateTimeKind.Local).AddTicks(2364)
                        });
                });
            ...
            modelBuilder.Entity("ActivitySeeker.Domain.Entities.State", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("state", "activity_seeker");
                });
            ...
            modelBuilder.Entity("ActivitySeeker.Domain.Entities.User", b =>
                {
                    b.HasOne("ActivitySeeker.Domain.Entities.State", "State")
                        .WithOne("User")
                        .HasForeignKey("ActivitySeeker.Domain.Entities.User", "StateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
