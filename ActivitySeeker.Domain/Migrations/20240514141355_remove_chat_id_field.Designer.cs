...
namespace ActivitySeeker.Domain.Migrations
{
    ...
    [Migration("20240514141355_remove_chat_id_field")]
    partial class remove_chat_id_field
    {
            ...
            modelBuilder.Entity("ActivitySeeker.Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 5, 22, 17, 13, 55, 492, DateTimeKind.Local).AddTicks(2512)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 5, 17, 17, 13, 55, 492, DateTimeKind.Local).AddTicks(2539)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 5, 15, 17, 13, 55, 492, DateTimeKind.Local).AddTicks(2542)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 6, 14, 17, 13, 55, 492, DateTimeKind.Local).AddTicks(2545)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 5, 14, 17, 13, 55, 492, DateTimeKind.Local).AddTicks(2549)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 5, 16, 17, 13, 55, 492, DateTimeKind.Local).AddTicks(2552)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 5, 19, 17, 13, 55, 492, DateTimeKind.Local).AddTicks(2555)
                        });
                });
