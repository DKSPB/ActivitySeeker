...
namespace ActivitySeeker.Domain.Migrations
{
    ...
    [Migration("20240624120128_add_state_column_to_user_table")]
    partial class add_state_column_to_user_table
    {
            ...
            modelBuilder.Entity("ActivitySeeker.Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 7, 2, 15, 1, 28, 544, DateTimeKind.Local).AddTicks(593)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 6, 27, 15, 1, 28, 544, DateTimeKind.Local).AddTicks(617)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 6, 25, 15, 1, 28, 544, DateTimeKind.Local).AddTicks(619)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 7, 24, 15, 1, 28, 544, DateTimeKind.Local).AddTicks(621)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 6, 24, 15, 1, 28, 544, DateTimeKind.Local).AddTicks(625)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 6, 26, 15, 1, 28, 544, DateTimeKind.Local).AddTicks(629)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 6, 29, 15, 1, 28, 544, DateTimeKind.Local).AddTicks(631)
                        });
                });
