...
namespace ActivitySeeker.Domain.Migrations
{
    ...
    [Migration("20240812114331_delete_field_name_fron_activity_table")]
    partial class delete_field_name_fron_activity_table
    {
            ...
            modelBuilder.Entity("ActivitySeeker.Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 20, 14, 43, 31, 459, DateTimeKind.Local).AddTicks(9811)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 15, 14, 43, 31, 459, DateTimeKind.Local).AddTicks(9833)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 13, 14, 43, 31, 459, DateTimeKind.Local).AddTicks(9835)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 9, 12, 14, 43, 31, 459, DateTimeKind.Local).AddTicks(9838)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 12, 14, 43, 31, 459, DateTimeKind.Local).AddTicks(9840)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 14, 14, 43, 31, 459, DateTimeKind.Local).AddTicks(9844)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 17, 14, 43, 31, 459, DateTimeKind.Local).AddTicks(9845)
                        });
                });
