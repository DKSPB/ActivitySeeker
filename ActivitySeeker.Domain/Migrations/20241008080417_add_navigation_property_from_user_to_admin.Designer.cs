...
namespace ActivitySeeker.Domain.Migrations
{
    ...
    [Migration("20241008080417_add_navigation_property_from_user_to_admin")]
    partial class add_navigation_property_from_user_to_admin
    {
            ...
            modelBuilder.Entity("ActivitySeeker.Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 16, 11, 4, 16, 884, DateTimeKind.Local).AddTicks(3870)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 11, 11, 4, 16, 884, DateTimeKind.Local).AddTicks(3894)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 9, 11, 4, 16, 884, DateTimeKind.Local).AddTicks(3897)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 8, 11, 4, 16, 884, DateTimeKind.Local).AddTicks(3899)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 8, 11, 4, 16, 884, DateTimeKind.Local).AddTicks(3901)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 10, 11, 4, 16, 884, DateTimeKind.Local).AddTicks(3904)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 13, 11, 4, 16, 884, DateTimeKind.Local).AddTicks(3906)
                        });
                });
