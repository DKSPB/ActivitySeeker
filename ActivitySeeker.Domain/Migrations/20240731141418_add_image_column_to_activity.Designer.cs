...
namespace ActivitySeeker.Domain.Migrations
{
    ...
    [Migration("20240731141418_add_image_column_to_activity")]
    partial class add_image_column_to_activity
    {
            ...
            modelBuilder.Entity("ActivitySeeker.Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 8, 17, 14, 18, 506, DateTimeKind.Local).AddTicks(2409)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 3, 17, 14, 18, 506, DateTimeKind.Local).AddTicks(2454)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 1, 17, 14, 18, 506, DateTimeKind.Local).AddTicks(2459)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 31, 17, 14, 18, 506, DateTimeKind.Local).AddTicks(2464)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 7, 31, 17, 14, 18, 506, DateTimeKind.Local).AddTicks(2467)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 2, 17, 14, 18, 506, DateTimeKind.Local).AddTicks(2471)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 5, 17, 14, 18, 506, DateTimeKind.Local).AddTicks(2473)
                        });
                });
