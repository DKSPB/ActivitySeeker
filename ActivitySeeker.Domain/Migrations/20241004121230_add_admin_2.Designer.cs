...
namespace ActivitySeeker.Domain.Migrations
{
    ...
    [Migration("20241004121230_add_admin_2")]
    partial class add_admin_2
    {
            ...
            modelBuilder.Entity("ActivitySeeker.Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 12, 15, 12, 29, 883, DateTimeKind.Local).AddTicks(7146)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 7, 15, 12, 29, 883, DateTimeKind.Local).AddTicks(7170)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 5, 15, 12, 29, 883, DateTimeKind.Local).AddTicks(7173)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 4, 15, 12, 29, 883, DateTimeKind.Local).AddTicks(7175)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 4, 15, 12, 29, 883, DateTimeKind.Local).AddTicks(7178)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 6, 15, 12, 29, 883, DateTimeKind.Local).AddTicks(7182)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 9, 15, 12, 29, 883, DateTimeKind.Local).AddTicks(7184)
                        });
                });
