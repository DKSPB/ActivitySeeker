...
namespace ActivitySeeker.Domain.Migrations
{
    ...
    [Migration("20241014104901_remove_offer_state1")]
    partial class remove_offer_state1
    {
            ...
            modelBuilder.Entity("ActivitySeeker.Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OfferState = 0,
                            StartDate = new DateTime(2024, 10, 22, 13, 49, 1, 14, DateTimeKind.Local).AddTicks(1661)
                        },
                        new
                        {
                            ...
                            OfferState = 0,
                            StartDate = new DateTime(2024, 10, 17, 13, 49, 1, 14, DateTimeKind.Local).AddTicks(1675)
                        },
                        new
                        {
                            ...
                            OfferState = 0,
                            StartDate = new DateTime(2024, 10, 15, 13, 49, 1, 14, DateTimeKind.Local).AddTicks(1677)
                        },
                        new
                        {
                            ...
                            OfferState = 0,
                            StartDate = new DateTime(2024, 11, 14, 13, 49, 1, 14, DateTimeKind.Local).AddTicks(1680)
                        },
                        new
                        {
                            ...
                            OfferState = 0,
                            StartDate = new DateTime(2024, 10, 14, 13, 49, 1, 14, DateTimeKind.Local).AddTicks(1683)
                        },
                        new
                        {
                            ...
                            OfferState = 0,
                            StartDate = new DateTime(2024, 10, 16, 13, 49, 1, 14, DateTimeKind.Local).AddTicks(1686)
                        },
                        new
                        {
                            ...
                            OfferState = 0,
                            StartDate = new DateTime(2024, 10, 19, 13, 49, 1, 14, DateTimeKind.Local).AddTicks(1688)
                        });
                });
