...
namespace ActivitySeeker.Domain.Migrations
{
    ...
    [Migration("20240816131633_create_images_table")]
    partial class create_images_table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActivitySeeker.Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 24, 16, 16, 33, 801, DateTimeKind.Local).AddTicks(5637)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 19, 16, 16, 33, 801, DateTimeKind.Local).AddTicks(5659)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 17, 16, 16, 33, 801, DateTimeKind.Local).AddTicks(5662)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 9, 16, 16, 16, 33, 801, DateTimeKind.Local).AddTicks(5665)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 16, 16, 16, 33, 801, DateTimeKind.Local).AddTicks(5668)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 18, 16, 16, 33, 801, DateTimeKind.Local).AddTicks(5672)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 8, 21, 16, 16, 33, 801, DateTimeKind.Local).AddTicks(5674)
                        });
                });
            ...
            modelBuilder.Entity("ActivitySeeker.Domain.Entities.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("image", "activity_seeker");
                });
            ...
            modelBuilder.Entity("ActivitySeeker.Domain.Entities.Image", b =>
                {
                    b.HasOne("ActivitySeeker.Domain.Entities.Activity", "Activity")
                        .WithMany("Images")
