...
namespace DataAccess.Migrations
{
    ...
    [Migration("20241022143503_remove_fk_from_user_to_admin")]
    partial class remove_fk_from_user_to_admin
    {
            ...
            modelBuilder.Entity("Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 30, 17, 35, 3, 165, DateTimeKind.Local).AddTicks(1737)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 25, 17, 35, 3, 165, DateTimeKind.Local).AddTicks(1765)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 23, 17, 35, 3, 165, DateTimeKind.Local).AddTicks(1768)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 22, 17, 35, 3, 165, DateTimeKind.Local).AddTicks(1770)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 22, 17, 35, 3, 165, DateTimeKind.Local).AddTicks(1772)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 24, 17, 35, 3, 165, DateTimeKind.Local).AddTicks(1775)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 27, 17, 35, 3, 165, DateTimeKind.Local).AddTicks(1777)
                        });
                });
