...
namespace DataAccess.Migrations
{
    ...
    [Migration("20241031130931_add_foreign_key_to_city")]
    partial class add_foreign_key_to_city
    {
            ...
            modelBuilder.Entity("Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 8, 16, 9, 31, 703, DateTimeKind.Local).AddTicks(9034)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 3, 16, 9, 31, 703, DateTimeKind.Local).AddTicks(9061)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 1, 16, 9, 31, 703, DateTimeKind.Local).AddTicks(9064)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 30, 16, 9, 31, 703, DateTimeKind.Local).AddTicks(9066)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 31, 16, 9, 31, 703, DateTimeKind.Local).AddTicks(9069)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 2, 16, 9, 31, 703, DateTimeKind.Local).AddTicks(9074)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 5, 16, 9, 31, 703, DateTimeKind.Local).AddTicks(9076)
                        });
                });
