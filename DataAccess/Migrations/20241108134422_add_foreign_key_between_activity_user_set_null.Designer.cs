...
namespace DataAccess.Migrations
{
    ...
    [Migration("20241108134422_add_foreign_key_between_activity_user_set_null")]
    partial class add_foreign_key_between_activity_user_set_null
    {
            ...
            modelBuilder.Entity("Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 16, 16, 44, 22, 591, DateTimeKind.Local).AddTicks(5443)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 11, 16, 44, 22, 591, DateTimeKind.Local).AddTicks(5467)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 9, 16, 44, 22, 591, DateTimeKind.Local).AddTicks(5469)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 12, 8, 16, 44, 22, 591, DateTimeKind.Local).AddTicks(5471)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 8, 16, 44, 22, 591, DateTimeKind.Local).AddTicks(5474)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 10, 16, 44, 22, 591, DateTimeKind.Local).AddTicks(5477)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 13, 16, 44, 22, 591, DateTimeKind.Local).AddTicks(5479)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.City", "ActivityCity")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Admin", "AdminProfile")
                        .WithMany()
                        .HasForeignKey("AdminProfileId");

                    b.HasOne("Domain.Entities.City", "UserCity")
                        .WithMany()
                        .HasForeignKey("CityId");

                    b.HasOne("Domain.Entities.Activity", "Offer")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.User", "OfferId")
