...
namespace DataAccess.Migrations
{
    ...
    [Migration("20241029142902_add_children_to_activity_type")]
    partial class add_children_to_activity_type
    {
            ...
            modelBuilder.Entity("Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 6, 17, 29, 2, 71, DateTimeKind.Local).AddTicks(3346)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 1, 17, 29, 2, 71, DateTimeKind.Local).AddTicks(3369)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 30, 17, 29, 2, 71, DateTimeKind.Local).AddTicks(3371)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 29, 17, 29, 2, 71, DateTimeKind.Local).AddTicks(3374)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 29, 17, 29, 2, 71, DateTimeKind.Local).AddTicks(3377)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 31, 17, 29, 2, 71, DateTimeKind.Local).AddTicks(3380)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 3, 17, 29, 2, 71, DateTimeKind.Local).AddTicks(3382)
                        });
                });
