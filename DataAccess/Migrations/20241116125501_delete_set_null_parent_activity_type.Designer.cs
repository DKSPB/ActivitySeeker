...
namespace DataAccess.Migrations
{
    ...
    [Migration("20241116125501_delete_set_null_parent_activity_type")]
    partial class delete_set_null_parent_activity_type
    {
            ...
            modelBuilder.Entity("Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 24, 15, 55, 0, 949, DateTimeKind.Local).AddTicks(7424)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 19, 15, 55, 0, 949, DateTimeKind.Local).AddTicks(7441)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 17, 15, 55, 0, 949, DateTimeKind.Local).AddTicks(7443)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 12, 16, 15, 55, 0, 949, DateTimeKind.Local).AddTicks(7446)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 16, 15, 55, 0, 949, DateTimeKind.Local).AddTicks(7451)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 18, 15, 55, 0, 949, DateTimeKind.Local).AddTicks(7456)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 21, 15, 55, 0, 949, DateTimeKind.Local).AddTicks(7458)
                        });
                });
