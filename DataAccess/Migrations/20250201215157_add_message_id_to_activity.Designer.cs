...
namespace DataAccess.Migrations
{
    ...
    [Migration("20250201215157_add_message_id_to_activity")]
    partial class add_message_id_to_activity
    {
            ...
            modelBuilder.Entity("Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2025, 2, 10, 0, 51, 56, 845, DateTimeKind.Local).AddTicks(243)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2025, 2, 5, 0, 51, 56, 845, DateTimeKind.Local).AddTicks(259)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2025, 2, 3, 0, 51, 56, 845, DateTimeKind.Local).AddTicks(261)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2025, 3, 2, 0, 51, 56, 845, DateTimeKind.Local).AddTicks(265)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2025, 2, 2, 0, 51, 56, 845, DateTimeKind.Local).AddTicks(269)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2025, 2, 4, 0, 51, 56, 845, DateTimeKind.Local).AddTicks(273)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2025, 2, 7, 0, 51, 56, 845, DateTimeKind.Local).AddTicks(277)
                        });
                });
