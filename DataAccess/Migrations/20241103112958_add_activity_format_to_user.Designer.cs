...
namespace DataAccess.Migrations
{
    ...
    [Migration("20241103112958_add_activity_format_to_user")]
    partial class add_activity_format_to_user
    {
            ...
            modelBuilder.Entity("Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 11, 14, 29, 57, 921, DateTimeKind.Local).AddTicks(1881)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 6, 14, 29, 57, 921, DateTimeKind.Local).AddTicks(1899)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 4, 14, 29, 57, 921, DateTimeKind.Local).AddTicks(1901)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 12, 3, 14, 29, 57, 921, DateTimeKind.Local).AddTicks(1904)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 3, 14, 29, 57, 921, DateTimeKind.Local).AddTicks(1908)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 5, 14, 29, 57, 921, DateTimeKind.Local).AddTicks(1913)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 8, 14, 29, 57, 921, DateTimeKind.Local).AddTicks(1917)
                        });
                });
