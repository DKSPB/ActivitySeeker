...
namespace DataAccess.Migrations
{
    ...
    [Migration("20241102175356_add_is_online_type_activity")]
    partial class add_is_online_type_activity
    {
            ...
            modelBuilder.Entity("Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 10, 20, 53, 56, 587, DateTimeKind.Local).AddTicks(4087)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 5, 20, 53, 56, 587, DateTimeKind.Local).AddTicks(4108)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 3, 20, 53, 56, 587, DateTimeKind.Local).AddTicks(4115)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 12, 2, 20, 53, 56, 587, DateTimeKind.Local).AddTicks(4121)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 2, 20, 53, 56, 587, DateTimeKind.Local).AddTicks(4128)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 4, 20, 53, 56, 587, DateTimeKind.Local).AddTicks(4133)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 7, 20, 53, 56, 587, DateTimeKind.Local).AddTicks(4136)
                        });
                });
