...
namespace DataAccess.Migrations
{
    ...
    [Migration("20241031122342_add_city_data")]
    partial class add_city_data
    {
            ...
            modelBuilder.Entity("Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 8, 15, 23, 41, 949, DateTimeKind.Local).AddTicks(3468)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 3, 15, 23, 41, 949, DateTimeKind.Local).AddTicks(3495)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 1, 15, 23, 41, 949, DateTimeKind.Local).AddTicks(3497)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 30, 15, 23, 41, 949, DateTimeKind.Local).AddTicks(3500)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 10, 31, 15, 23, 41, 949, DateTimeKind.Local).AddTicks(3502)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 2, 15, 23, 41, 949, DateTimeKind.Local).AddTicks(3505)
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 11, 5, 15, 23, 41, 949, DateTimeKind.Local).AddTicks(3507)
                        });
                });
