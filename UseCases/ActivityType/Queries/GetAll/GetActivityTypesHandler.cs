...
{
    public class GetActivityTypesHandler : IRequestHandler<GetActivityTypesQuery, List<ActivityTypeDto>>
    {
        ...
        public async Task<List<ActivityTypeDto>> Handle(GetActivityTypesQuery request, CancellationToken cancellationToken)
        {
